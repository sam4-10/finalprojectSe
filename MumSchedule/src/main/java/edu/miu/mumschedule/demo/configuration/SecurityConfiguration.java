...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/SE_Final_Project-1/SE_Final_Project/src/resources/static/**", "/images/**", "/css/**", "/auction/public/**").permitAll()
                .antMatchers("/auction/secured/admin/**", "/SE_Final_Project-1/SE_Final_Project/src/resources/secured/admin/**", "/auction/admin/**", "/templates/secured/admin/**").hasRole("ADMIN")
               .antMatchers("/auction/secured/seller/**", "/SE_Final_Project-1/SE_Final_Project/src/resources/secured/seller/**","/seller/**").hasRole("SELLER")
                .antMatchers("/auction/secured/customer/**", "/SE_Final_Project-1/SE_Final_Project/src/resources/secured/customer/**","/auction/customer/**").hasRole("CUSTOMER")
